...
export function ProblemDetailSheet({ problem, onClose, onEdit, onDelete }: ProblemDetailSheetProps) {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-lg rounded-t-3xl bg-white dark:bg-gray-900 shadow-2xl max-h-[85dvh] flex flex-col">
          {/* Handle bar */}
          ...
          <div className="overflow-y-auto px-6 pb-8 pt-3 flex flex-col gap-5">
            ...
            {/* Answer */}
            <div>
              <p className="text-xs font-semibold text-indigo-400 uppercase tracking-wide mb-1.5">정답</p>
            ...
            {problem?.memo && (
              <div className="rounded-xl bg-gray-50 dark:bg-gray-800 p-4">
                <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-2">메모</p>
