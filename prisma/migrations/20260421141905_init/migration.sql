...
-- CreateIndex
CREATE UNIQUE INDEX "MistakeNote_problemId_key" ON "MistakeNote"("problemId");

-- CreateIndex
CREATE INDEX "MistakeNote_userId_skipCount_hintCount_idx" ON "MistakeNote"("userId", "skipCount", "hintCount");
...
-- AddForeignKey
ALTER TABLE "MistakeNote" ADD CONSTRAINT "MistakeNote_problemId_fkey" FOREIGN KEY ("problemId") REFERENCES "Problem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
